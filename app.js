...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- LocalStorage Setup ---
    function initDB() {
        // Force reset for demonstration of new books
        localStorage.removeItem('bookvault_books');
        
        if (!localStorage.getItem('bookvault_books')) {
            const dummyData = [
                ...
                { id: 10, title: "Can I Get a Chocolate Milkshake?", author: "Unknown", genre: "Productivity", status: "Completed", rating: 4, totalPages: 250, pagesRead: 250, notes: "Great read.", checklist: ["Started", "Currently Reading", "Completed"] },
                { id: 11, title: "Boots, Belts, and Berets", author: "Tanushree Podder", genre: "Productivity", status: "To Read", rating: 0, totalPages: 280, pagesRead: 0, notes: "", checklist: [] },
                { id: 12, title: "Lone Fox Dancing", author: "Ruskin Bond", genre: "Non-Fiction", status: "Currently Reading", rating: 0, totalPages: 292, pagesRead: 100, notes: "Autobiography of a great storyteller.", checklist: ["Started", "Currently Reading"] },
                { id: 13, title: "The Story of My Experiments with Truth", author: "Mahatma Gandhi", genre: "Non-Fiction", status: "To Read", rating: 0, totalPages: 448, pagesRead: 0, notes: "", checklist: [] },
                { id: 14, title: "Eragon", author: "Christopher Paolini", genre: "Fiction", status: "Completed", rating: 5, totalPages: 509, pagesRead: 509, notes: "Classic dragon rider story.", checklist: ["Started", "Currently Reading", "Completed", "Notes Added"] },
                { id: 15, title: "Eldest", author: "Christopher Paolini", genre: "Fiction", status: "To Read", rating: 0, totalPages: 668, pagesRead: 0, notes: "", checklist: [] },
                { id: 16, title: "Brisingr", author: "Christopher Paolini", genre: "Fiction", status: "To Read", rating: 0, totalPages: 748, pagesRead: 0, notes: "", checklist: [] },
                { id: 17, title: "Inheritance", author: "Christopher Paolini", genre: "Fiction", status: "To Read", rating: 0, totalPages: 860, pagesRead: 0, notes: "", checklist: [] }
            ];
