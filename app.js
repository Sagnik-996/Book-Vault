...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (mockSettings) {
        mockSettings.addEventListener('click', (e) => {
            e.preventDefault();
            e.stopPropagation();
            showToast("Account Settings clicked (Demo Mode)");
            profileWidget.classList.remove('active');
            profileDropdown.classList.remove('active');
        });
    }
    ...
    const mockLogout = document.getElementById('mock-logout');
    if (mockLogout) {
        mockLogout.addEventListener('click', (e) => {
            e.preventDefault();
            e.stopPropagation();
